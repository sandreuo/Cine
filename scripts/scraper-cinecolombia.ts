...
const CINECOLOMBIA_CINEMA_CITY: Record<string, string> = {
  ...
  'CARIBE PLAZA': 'barranquilla',
  'PALMETTO': 'barranquilla',
  'BUENAVISTA': 'barranquilla',
  'OVIEDO': 'medellin',
  'VIZCAYA': 'medellin',
  'CAÑAVERAL': 'bucaramanga',
  'DELACUESTA': 'bucaramanga',
  'PARQUE ALEGRA': 'monteria',
  'VICTORIA': 'pereira',
  'PASEO LA CASTELLANA': 'cartagena',
  'MOLINOS': 'bogota',
  'LUMINA': 'bogota',
  'PLAZA CENTRAL': 'bogota',
  'MERCURIO': 'bogota',
  'PORTOALEGRE': 'bogota',
  'AMERICAS': 'bogota',
  'GRAN ESTACIÓN': 'bogota',
  'GRAN ESTACION': 'bogota',
  'AVENIDA CHILE': 'bogota',
  'GALERIAS': 'bogota',
  'GALERÍAS': 'bogota',
  'EMBAJADOR': 'bogota',
  'CEDRITOS': 'bogota',
